...
/**
 * Interface for AccountingParametersDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface IAccountingParametersDAO {
	/**
	 ...
	 * IAccountingParametersDAO.save(entity);
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * IAccountingParametersDAO.delete(entity);
	 * EntityManagerHelper.commit();
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = IAccountingParametersDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
