...
public class FuelsTanksDAO implements IFuelTanksDAO {
	// property constants
	...
	public void delete(FuelTanks entity) {
		EntityManagerHelper
				.log("deleting FuelTanks instance", Level.INFO, null);
		try {
			entity = getEntityManager().getReference(FuelTanks.class,
					entity.getFtaCodigo());
	...
	public FuelTanks update(FuelTanks entity) {
		EntityManagerHelper
				.log("updating FuelTanks instance", Level.INFO, null);
		try {
	...
	public FuelTanks findById(Long id) {
		EntityManagerHelper.log("finding FuelTanks instance with id: " + id,
				Level.INFO, null);
		try {
	...
	public List<FuelTanks> findByProperty(String propertyName,
			final Object value) {
		EntityManagerHelper.log("finding FuelTanks instance with property: "
				+ propertyName + ", value: " + value, Level.INFO, null);
		try {
			final String queryString = "select model from FuelTanks model where model."
	...
	public List<FuelTanks> findAll() {
		EntityManagerHelper.log("finding all FuelTanks instances", Level.INFO,
				null);
		try {
