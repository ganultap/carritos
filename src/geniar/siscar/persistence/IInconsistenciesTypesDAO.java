...
/**
 * Interface for InconsistenciesTypesDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface IInconsistenciesTypesDAO {
	/**
	 ...
	 * IInconsistenciesTypesDAO.save(entity);
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * IInconsistenciesTypesDAO.delete(entity);
	 * EntityManagerHelper.commit();
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = IInconsistenciesTypesDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
