...
/**
 * Interface for DocumentTwoDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface IDocumentTwoDAO {
	/**
	 * Perform an initial save of a previously unsaved DocumentTwo entity. All
	 * subsequent persist actions of this entity should use the #update()
	 * method. This operation must be performed within the a databases
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = IDocumentTwoDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	 ...
	 */
	public List<DocumentTwo> findByProperty(String propertyName, Object value);
