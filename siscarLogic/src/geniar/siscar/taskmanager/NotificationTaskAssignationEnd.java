 ...
 */
public class NotificationTaskAssignationEnd extends TimerTask
{
	private Timer timer = null;
	private String repeticionHorasStr;
	private String factorConversionHorasMilisegs;
	private static final Log log = LogFactory.getLog(NotificationTaskAssignationEnd.class);
	 ...
	 * @param time
	 */
	public NotificationTaskAssignationEnd(Date time)
	{
		try 
		{
			...
			getTimer().scheduleAtFixedRate(new NotificationTaskAssignationEnd(),time,repeticionMilisegundos);			
		} 
	...
	public NotificationTaskAssignationEnd()
	{
	...
	public void run()
	{
		...
		{	
			...
			int horaInicialRangoEjecucion = Integer.parseInt(Util.loadParametersValue("HORA_INICIAL_RANGO_EJECUCION_I"));
			int minutosInicialRangoEjecucion = Integer.parseInt(Util.loadParametersValue("MINUTOS_INICIAL_RANGO_EJECUCION_I"));			
			
			int horaFinalRangoEjecucion = Integer.parseInt(Util.loadParametersValue("HORA_FINAL_RANGO_EJECUCION_I"));
			int minutosFinalRangoEjecucion = Integer.parseInt(Util.loadParametersValue("MINUTOS_FINAL_RANGO_EJECUCION_I"));
    		...
    		//Pregunta si la hora actual esta dentro del rango de ejecucion de la tarea
	 		...
	 		{	 			
	 			Date start = new Date();
				log.info("--- Corriendo proceso automatico Envio de notificacion fecha terminacion de asignacion"+start+"----");
				new NotificationsServiceImpl().notificacionFechaDevolucionAsignacion();
			...
			{
				log.info("--- Tarea Automatica de notificacion fecha de terminacion de asignacion en espera... " + new Date() + " ----");
			}
		}
		catch (Exception e) 
		{
