...
public abstract class FileUtils {
			...
			if (null != list) {
				for (String list_entry : list) {
					...
					for (String file_name : dir) {
						if (root) {
							// if the file is not accepted, don't process it
							// further
	...
	public static void copyFile(File source, File target) throws FileUtilsErrorException {
		if (null == source)
			throw new IllegalArgumentException("source can't be null.");
		if (null == target)
			throw new IllegalArgumentException("target can't be null.");
	...
	public static void copyDirectory(File source, File target) throws FileUtilsErrorException {
		if (null == source)
			throw new IllegalArgumentException("source can't be null.");
		if (null == target)
			throw new IllegalArgumentException("target can't be null.");
		...
		for (String filelist_element : filelist) {
			...
			if (current_file.isDirectory()) {
				copyDirectory(current_file, target_file);
			} else {
	...
	public static void moveDirectory(File source, File target) throws FileUtilsErrorException {
		...
		// If we get here it means we're finished with this directory ... delete
		// it.
		deleteFile(source);
