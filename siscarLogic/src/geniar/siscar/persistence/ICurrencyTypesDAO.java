...
/**
 * Interface for CurrencyTypesDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface ICurrencyTypesDAO {
	/**
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * ICurrencyTypesDAO.delete(entity);
	 * EntityManagerHelper.commit();
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = ICurrencyTypesDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	 ...
	 */
	public List<CurrencyTypes> findByProperty(String propertyName, Object value);
