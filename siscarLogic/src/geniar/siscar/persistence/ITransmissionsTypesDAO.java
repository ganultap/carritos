...
/**
 * Interface for TransmissionsTypesDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface ITransmissionsTypesDAO {
	/**
	 ...
	 * ITransmissionsTypesDAO.save(entity);
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * ITransmissionsTypesDAO.delete(entity);
	 * EntityManagerHelper.commit();
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = ITransmissionsTypesDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	 ...
	 */
	public List<TransmissionsTypes> findByProperty(String propertyName, Object value);
